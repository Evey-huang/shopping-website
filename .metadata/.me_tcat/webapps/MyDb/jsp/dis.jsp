		...
		<%	ArrayList<Student> students = (ArrayList) request.getAttribute("students");
			...
			for (int i = 0; i < students.size(); i++) {%>
					<tr>
					    ...
					    <td class="danger"><a href="/MyDb/jsp/updateStudent.jsp?id=<%=students.get(i).getId()%>&name=<%=students.get(i).getName()%>&bookname=<%=students.get(i).getBookName()%>&currentPage=${sessionScope.currentPage}">修改</a></td>
